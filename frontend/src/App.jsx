...
export default function App() {
  ...
  // Auth event listeners & callbacks
  ...
  useEffect(() => {
    const handleUnauthorized = () => {
      setToken('');
      setUser(null);
      showToast('Seans muddati tugadi, qaytadan kiring', 'error');
    };
  ...
  if (!token) {
    return (
      <div className="min-h-screen">
        {/* Toast Notification */}
        {toast && (
          <div className="fixed bottom-6 right-6 z-[99] flex items-center gap-3.5 px-4.5 py-3.5 glass-modal rounded-2xl shadow-2xl animate-slideUp max-w-md border border-white/60">
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <Sidebar activeTab={activeTab} setActiveTab={setActiveTab} onQuickAction={handleDashboardAction} onLogout={handleLogout} />
